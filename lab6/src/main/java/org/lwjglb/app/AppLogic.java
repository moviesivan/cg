...
public class AppLogic implements ILogic {
    ...
    private float lightIntensity = 25f;
    ...
    public void init(Window window) throws Exception {
        ...
        PointLight.Attenuation att = new PointLight.Attenuation(1f, 1f, 1.0f);
    ...
    public void update(float interval, MouseInput mouseInput) {
        ...
        timer += 2;
        timer %= 360;
        float newIntensity = lightIntensity * (1 +(float) Math.sin(Math.toRadians(timer)));
